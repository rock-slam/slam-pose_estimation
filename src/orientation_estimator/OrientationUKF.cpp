#include "orientation_estimator/OrientationUKF.hpp"
...
namespace pose_estimation
{
    ...
    OrientationUKF::OrientationUKF(const State &initial_state, const Covariance &state_cov,
                                   double gyro_bias_tau, double acc_bias_tau, const LocationConfiguration &location) : gyro_bias_tau(gyro_bias_tau), acc_bias_tau(acc_bias_tau)
    {
